...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { nota: @request.nota, status: @request.status, tipo: @request.tipo } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { nota: @request.nota, status: @request.status, tipo: @request.tipo } }
